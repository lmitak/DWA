...
try{
    ...
    if($lang == "ENG")
        $sql = "SELECT id, naziv, kratkiOpis, image  FROM jelo WHERE idKategorije = 4 AND idJezika = 2";
    else
        $sql = "SELECT id, naziv, kratkiOpis, image  FROM jelo WHERE idKategorije = 4 AND idJezika = 1";
